        ...
        <div class="content-center">
            ...
            <?php
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    $i++;
                    echo "'>";
					echo "<td style='text-align: center'>" . $row["employee"] . "</td>";
                    echo "<td style='text-align: center'>" . $row["building"] . "</td>";
					echo "<td style='text-align: center'>" . $row["floar"] . "</td>";
					echo "<td style='text-align: center'>" . $row["department"] . "</td>";
                    echo "<td style='text-align: center'>" . $row["category"] . '</td>';
					echo "<td style='text-align: center'>" . $row["tag"] . "</td>";
                    echo '<td style="text-align: center">' . $row['quantity'] . '</td>';
                    echo '<td style="text-align: center">' .'ETB '. $row['price'] . '</td>';
                    echo '<td style="text-align: center">'.'ETB '.$row['quantity'] * $row['price'] . '</td>';
