...
<div id="page">
    ...
    <div class="content-center">
        <div id="topic"><h3><?php echo $asset_data['employee'];?></h3></div>
            ...
            <table border=0>
                ...
                <form action="" method="post">
					<td><input style="text-align: center" type="text" value="<?php echo $asset_data['employee'];?>" name="title"></td>
                    <td><input style="text-align: center" type="text" value="<?php echo $asset_data['building'];?>" name="title"></td>
					<td><input style="text-align: center" type="text" value="<?php echo $asset_data['floar'];?>" name="title"></td>
					<td><input style="text-align: center" type="text" value="<?php echo $asset_data['department'];?>" name="title"></td>
                    <td><input style="text-align: center" type="text" value="<?php echo $asset_data['category'];?>" name="category"></td>
					<td><input style="text-align: center" type="text" value="<?php echo $asset_data['tag'];?>" name="title"></td>
