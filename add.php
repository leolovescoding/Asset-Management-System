...
<?php
            ...
            if(empty($_POST['add_asset'])===false) {
                ...
                $reuired_fields = array('employee', 'building', 'floar', 'department', 'category', 'tag', 'quantity', 'price');
            ...
            <form name="add-asset" method='POST' action='add.php' onsubmit="return validateForm()">
                <table border=0>
					<tr>
                        ...
                        <td id='input-col'>
                            <input type='text' name='employee' required maxlength=30> </td>
                    </tr>
                    <tr>
                        <td id='label-col'>
                            <label>Building*</label> </td>
                        <td id='input-col'>
                            <input type='text' name='building' required maxlength=30> </td>
                    </tr>
					<tr>
                        <td id='label-col'>
                            <label>Floar*</label> </td>
                        <td id='input-col'>
                            <input type='text' name='floar' required maxlength=30> </td>
                    </tr>
					<tr>
                        <td id='label-col'>
                            <label>Department*</label> </td>
                        <td id='input-col'>
                            <input type='text' name='department' required maxlength=30 oninput="activate('add-asset', this, 'quantity')"> </td>
                    </tr>
                    <tr>
                        <td id='label-col'>
					...
					<tr>
                        <td id='label-col'>
                            <label>Tag**</label> </td>
                        <td id='input-col'>
                            <input type='text' name='tag' required maxlength=30> </td>
                    </tr>
                    <tr>
                        <td id='label-col'>
